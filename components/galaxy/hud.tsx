...
type GalaxyHudCardProps = {
  children: ReactNode
  className?: string
}

export function GalaxyHudCard({ children, className }: GalaxyHudCardProps) {
  return (
    <Surface
      as="section"
      variant="glass"
...
type GalaxyHudTitleProps = {
  icon: ReactNode
  label: string
  meta?: string
}

export function GalaxyHudTitle({ icon, label, meta }: GalaxyHudTitleProps) {
  return (
    <SectionHeader
      label={label}
      meta={meta}
...
export function GalaxyHudStat({ label, value }: { label: string; value: number | string }) {
  return (
    <div>
...
export function GalaxyHudAction({ icon, label, onClick }: { icon: ReactNode; label: string; onClick: () => void }) {
  return (
    <Button
      variant="inline"
...
export function GalaxyFilterRow({
  color,
  label,
  active,
  onClick,
...
export function GalaxySwitchRow({ label, active, onClick }: { label: string; active: boolean; onClick: () => void }) {
  return (
...
export function GalaxyHudMetric({
  icon,
  label,
  value,
  tone,
...
export function GalaxyLegendRow({ color, label, value }: { color: string; label: string; value: number | string }) {
  return (
