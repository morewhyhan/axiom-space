...
export default function GalaxyFilter() {
  ...
  return (
    <aside className="side-slot visible galaxy-panel flex-col pointer-events-auto no-scrollbar" style={{ width: 'var(--panel-sm)', justifyContent: 'flex-start', gap: 'var(--space-sections)', padding: 'var(--panel-py) 0' }}>
      ...
      <div>
        ...
        <div className="flex items-center gap-2 bg-white/5 px-3 py-2.5 rounded-lg border border-white/5 cursor-pointer mb-3 group" onClick={() => openModal('search')}>
        ...
        <div className="flex items-center gap-2 bg-white/5 px-3 py-2.5 rounded-lg border border-white/5 cursor-pointer group" onClick={() => openModal('importtext')}>
