  ...
  return (
    <aside className="side-slot visible dashboard-panel flex-col pointer-events-auto" style={{ width: 'var(--panel-sm)', justifyContent: 'space-evenly' }}>
      <div>
        ...
        <div className="serif font-bold glow-text-purple leading-none mt-1" style={{ fontSize: 'var(--t-hero)' }}>378</div>
      ...
      <div>
        ...
        <div className="serif font-bold glow-text-cyan leading-none mt-1" style={{ fontSize: 'var(--t-huge)' }}>1,816</div>
      ...
      <div>
        ...
        <div className="serif font-bold text-purple-300 leading-none mt-1" style={{ fontSize: 'var(--t-big)' }}>156</div>
      ...
      <div>
        ...
        <div className="serif font-bold text-cyan-300 leading-none mt-1" style={{ fontSize: 'var(--t-big)' }}>89</div>
      ...
      <div>
        ...
        <div className="serif font-bold text-pink-300 leading-none mt-1" style={{ fontSize: 'var(--t-big)' }}>133</div>
      ...
      <div className="flex gap-3">
        ...
        <div>
          ...
          <div className="text-sm text-white font-bold mt-0.5">System stable — learning active</div>
          <p className="text-white/35 leading-relaxed mt-1" style={{ fontSize: 'var(--f10)' }}>Knowledge base healthy. Agent online. All connections nominal.</p>
        </div>
      </div>
