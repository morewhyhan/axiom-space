...
const IMPLEMENTATION_FILES = [
  ...
  'components/learn/workspace/push-suggestion-box.tsx',
  'types/learning.ts',
  'types/galaxy.ts',
  'types/agent.ts',
]
...
const CASE_IMPLEMENTATION_MARKERS: Record<string, RegExp[]> = {
  ...
  SRV: [/Service|Engine|importDocumentTool|push-suggestion-engine|pathAdjustmentEngine|GraphIntegrationManager|syncEdgesFromContent/i],
